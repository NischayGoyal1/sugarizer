...
var app = new Vue({
	...
	data: {
		...
		l10n: {
			...
			stringTutoTrophyCardintro: '',
			stringTutoSettingsCategoryCardTitle: '',
			stringTutoSettingsCategoryCardintro: '',
			stringTutoSettingsSkillCardTitle: '',
			stringTutoSettingsSkillCardintro: '',
			stringTutoSettingsEditButtonTitle: '',
			stringTutoSettingsEditButtonintro: '',
			stringTutoSettingsDeleteButtonTitle: '',
			stringTutoSettingsDeleteButtonintro: '',
			stringTutoSettingsNotationButtonTitle: '',
			stringTutoSettingsNotationButtonintro: '',
			stringTutoSettingsAddButtonTitle: '',
			stringTutoSettingsAddButtonintro: '',
			stringTutoExplainTitle: '',
			stringTutoExplainintro: '',
			stringTutoTemplateSelectionTitle: '',
			stringTutoTemplateSelectionintro: '',
			stringTutoTemplateTitle: '',
			stringTutoTemplateintro: '',
			stringTutoAddTemplateTitle: '',
			stringTutoAddTemplateintro: '',
			stringTutoCategoryCardTitle: '',
			stringTutoCategoryCardintro: '',
			stringTutoCategorySkillsTitle: '',
			stringTutoCategorySkillsintro: '',
			stringTutoCategoryProgressTitle: '',
			stringTutoCategoryProgressintro: '',
			stringTutoCategorySearchTitle: '',
			stringTutoCategorySearchintro: '',
			stringTutoRewardsButtonTitle: '',
			stringTutoRewardsButtonintro: '',
			stringTutoSettingsButtonTitle: '',
			stringTutoSettingsButtonintro: '',
			stringTutoExportButtonTitle: '',
			stringTutoExportButtonintro: '',
			stringTutoNetworkButtonTitle: '',
			stringTutoNetworkButtonintro: '',
			stringTutoSkillCardTitle: '',
			stringTutoSkillCardintro: '',
			stringTutoHomeButtonTitle: '',
			stringTutoHomeButtonintro: '',
			stringTutoSkillSearchTitle: '',
			stringTutoSkillSearchintro: '',
			stringTutoSkillUploadsTitle: '',
			stringTutoSkillUploadsintro: '',
			stringTutoAcquireButtonTitle: '',
			stringTutoAcquireButtonintro: '',
			stringTutoUploadButtonTitle: '',
			stringTutoUploadButtonintro: '',
			stringTutoUploadedItemTitle: '',
			stringTutoUploadedItemintro: ''
		}
	},
	watch: {
